...
<head>
  ...
  <style>
    /* ── Paginaspecifiek: setup-card layout, totp-input, success-block ── */
    .setup-card {
...
<div class="adm-page">
  <h1 class="adm-page-title">&#128272; Tweestapsverificatie instellen</h1>
  ...
  <?php if ($fase === 'done'): ?>
    ...
    <div class="success-block">
      ...
      <a href="<?= BASE_URL ?>/admin/admins.php" class="btn btn-primary">Terug naar accounts</a>
    </div>
  ...
  <?php else: ?>
    ...
    <div class="setup-step">
      ...
      <div class="step-body">
        ...
        <div class="qr-wrap">
          <img src="<?= h($qrUrl) ?>" alt="TOTP QR-code" width="200" height="200" loading="lazy">
          <p style="font-size:.75rem;color:var(--adm-muted);margin:0;">Scan met uw authenticator-app</p>
        </div>
        <p style="margin-top:.75rem;font-size:.82rem;color:var(--adm-muted);">Of voer deze sleutel handmatig in:</p>
        <div class="secret-code">
          <span><?= h(wordwrap($tempSecret, 4, ' ', true)) ?></span>
